  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <ul className='list-none hidden md:flex flex-row gap-5 lg:gap-10 md:gap-3'>
          {navLinks.map((nav) => (
            <motion.li
              key={nav.id}
              initial={{ opacity: 0, y: -20 }}
            ...
            >
              <a
                ...
                } hover:text-white text-[16px] font-medium cursor-pointer transition-colors duration-300`}
